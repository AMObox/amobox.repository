...
def getFilmes(url, pagina):
	...
	mensagemprogresso.create('Tuga[COLOR yellow].io[/COLOR]', 'A abrir lista de filmes','Por favor aguarde...')
...
def player(name,url,iconimage):
	...
	mensagemprogresso.create('Tuga[COLOR yellow].io[/COLOR]', u'Abrir emissão','Por favor aguarde...')
