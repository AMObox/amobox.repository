...
import zipfile
import ntpath
import plugin.program.amoboxcbtool
...
def killxbmc():
    ...
    if myplatform == 'osx': # OSX
        ...
        dialog.ok("[COLOR=red][B]WARNING  !!![/COLOR][/B]", "If you are seeing this message it means the force close", "was unsuccessful. Please force close XBMC/Kodi [COLOR=lime]DO NOT[/COLOR] exit cleanly via the menu.",'')
        ...
        dialog.ok("[COLOR=red][B]WARNING  !!![/COLOR][/B]", "If you are seeing this message it means the force close", "was unsuccessful. Please force close XBMC/Kodi [COLOR=lime]DO NOT[/COLOR] exit cleanly via the menu.","Use task manager and NOT ALT F4")
    else: #ATV
        ...
        dialog.ok("[COLOR=red][B]WARNING  !!![/COLOR][/B]", "If you are seeing this message it means the force close", "was unsuccessful. Please force close XBMC/Kodi [COLOR=lime]DO NOT[/COLOR] exit via the menu.","Your platform could not be detected so just pull the power cable.")    
